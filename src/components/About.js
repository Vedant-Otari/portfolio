...
export default function About() {
  return (
    <section className="bg-gray-100 pt-3" id="about">
      <div className="flex flex-col overflow-hidden m-6 lg:w-3/4 lg:mx-auto shadow-md shadow-gray-400 bg-white rounded-xl">
        <h3 className="text-center text-2xl py-4 uppercase lg:text-4xl font-mono">Profile</h3>
        <div className="lg:flex items-center">
          <img
            className="mx-auto rounded-2xl lg:w-1/5 h-fit shadow-sm w-1/2"
            src={img}
            alt=""
          />
          <div className="flex flex-col py-5 px-7 lg:w-1/2">
            <div className="py-2">
        ...
        <div className="bg-gray-400 flex w-full px-5 py-2 lg:py-4 justify-around text-3xl">
          <a
      ...
      <div className="bg-slate-400 p-5 text-white">
        <h2 className="text-center text-4xl lg:text-5xl lg:py-3 w-full">About Me</h2>
        <article className="pt-5 lg:w-3/4 lg:text-left mx-auto lg:text-xl text-center">
